package com.vinsguru.movie.controller.advice;
...
public class ApplicationErrorHandler {
    ...
    public ProblemDetail handler(MovieNotFoundException exception) {
    ...
    public ProblemDetail handler(ResourceAccessException exception) {
