...
public class Lec04UpDownCounterDemo {
    ...
    public static void main(String[] args) {
        var counter = createActiveTaskCounter();
    ...
    // thread safe
    private static LongUpDownCounter createActiveTaskCounter() {
        return meter.upDownCounterBuilder("app.task.active.count")
    ...
    private static class TaskExecutor {
        ...
        public TaskExecutor(LongUpDownCounter counter, ExecutorService executorService) {
